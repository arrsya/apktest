    ...
    public static void checkDeviceAllowed(String androidId, DeviceCheckCallback callback) {
        fetchAllowedIds(new DeviceFetchCallback() {
            ...
            public void onError(Exception e) {
                callback.onError(new Exception("Terjadi kesalahan. Coba lagi.")); // PATCH: generic error
            }
        });
    }
    ...
    private static void fetchAllowedIds(DeviceFetchCallback callback) {
        new Thread(() -> {
            try {
                ...
                new Handler(Looper.getMainLooper()).post(() -> callback.onError(new Exception("Terjadi kesalahan. Coba lagi."))); // PATCH: generic error
            }
        }).start();
    }
